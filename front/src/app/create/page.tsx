...
export default function BookForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="space-y-12 py-12 px-96 bg-gradient-to-r from-pink-600/60 to-cyan-700/70">
        <div className="bg-white pb-12 py-2 px-12 shadow-2xl">
          <h1 className="mx-auto mt-2 w-fit h-8 bg-clip-text text-transparent bg-gradient-to-r from-pink-600/60 to-cyan-700/70 text-3xl text-center font-semibold leading-7 ">Book Registration</h1>

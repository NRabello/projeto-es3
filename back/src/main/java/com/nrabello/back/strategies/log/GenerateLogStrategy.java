package com.nrabello.back.strategies.log;
...
public class GenerateLogStrategy implements IStrategy<Book> {
    ...
    private void printBookDetails(Book book) {
        ...
        System.out.println("Valor de Aquisição: " + book.getAcquisitionValue());
